...
export class NftsService {
    ...
    addFavorites(url: string, favorites: Favorites) {
        return this.http.post(url, favorites)
    }
    ...
    removeItemFromFavorites(nftDna: any) {
        // let favoritesData = localStorage.getItem('localCart')
        // if (favoritesData) {
    ...
    removeFavorite(userId: string) {
        // return this.http.delete(`https://63c6dcabdcdc478e15cb18f7.mockapi.io/api/v3/favorite/${userId}`)
    }
